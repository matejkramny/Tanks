...
public class Object implements GameStateInterface {
	...
	protected void loadTexture(String path) { // Not efficient.. Move to its own class for reusability?
		try {
	...
	protected void drawVerts () {
		if (this.texture != null){ texture.bind();  }
		GL11.glBegin(GL11.GL_QUADS);
		{
			if (this.texture != null) GL11.glTexCoord2d(0, 0);
			GL11.glVertex2d(0, 0);
			if (this.texture != null) GL11.glTexCoord2d(0, texture.getHeight());
			GL11.glVertex2d(0, h);
			if (this.texture != null) GL11.glTexCoord2d(texture.getWidth(), texture.getHeight());
			GL11.glVertex2d(w, h);
			if (this.texture != null) GL11.glTexCoord2d(texture.getWidth(), 0);
			GL11.glVertex2d(w, 0);
		}
		GL11.glEnd();
	}
	...
	public boolean checkCollision (Object o) {// Not efficient.. Move to its own class for reusability?
